...
public class JobPost implements JobPostOption{
 public void  jobPost(){
     ...
     try (PrintWriter writer = new PrintWriter(new FileWriter("job_data.txt", true))) {
         writer.println(
                 companyName + "_" + position + "_" + subjectField + "_" + educationLevel + "_" + cgpa + "_" + jobDescription + "_" + salary + "_" + location + "_" + jobType + "_" + deadline + "_" + contactEmail
         );
     } catch (IOException e) {
 ...
 public void back() {
     ...
     System.out.println("1. Post another job");
